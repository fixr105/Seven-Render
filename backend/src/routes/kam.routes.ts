...
router.post('/clients/:id/form-links', kamController.createFormLink.bind(kamController));
router.get('/record-titles', kamController.getRecordTitles.bind(kamController));
router.post('/record-titles', kamController.createRecordTitle.bind(kamController));
