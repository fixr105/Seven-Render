...
export const B2C_EV_STAGES: B2cEvStage[] = [
  ...
  },
  {
    id: 'borrower',
    title: 'Borrower',
    description: 'Auto-filled from PAN verification — read only',
    fields: [
      { key: 'borrower.firstName', label: 'First Name', type: 'text', required: true, readOnly: true },
      { key: 'borrower.lastName', label: 'Last Name', type: 'text', required: true, readOnly: true },
      { key: 'borrower.customerName', label: 'Customer Name', type: 'text', readOnly: true },
      { key: 'borrower.gender', label: 'Gender', type: 'select', required: true, readOnly: true, options: GENDER_OPTIONS },
      { key: 'borrower.dob', label: 'Date of Birth', type: 'date', required: true, readOnly: true },
      { key: 'borrower.fatherName', label: 'Father Name', type: 'text', required: true, readOnly: true },
      { key: 'borrower.mobile', label: 'Mobile Number', type: 'tel', required: true, readOnly: true },
      { key: 'borrower.email', label: 'Email', type: 'email', required: true, readOnly: true },
      { key: 'borrower.pan', label: 'PAN Card', type: 'text', required: true, readOnly: true },
      { key: 'borrower.drivingLicense', label: 'Driving License', type: 'text', readOnly: true },
      { key: 'borrower.address.line1', label: 'Address Line 1', type: 'text', required: true, readOnly: true, colSpan: 2 },
      { key: 'borrower.address.line2', label: 'Address Line 2', type: 'text', readOnly: true },
      { key: 'borrower.address.village', label: 'Village', type: 'text', required: true, readOnly: true },
      { key: 'borrower.address.pincode', label: 'Pincode', type: 'text', required: true, readOnly: true },
      { key: 'borrower.address.district', label: 'District', type: 'text', required: true, readOnly: true },
      { key: 'borrower.address.state', label: 'State', type: 'text', required: true, readOnly: true },
    ],
  },
  {
    id: 'loan',
